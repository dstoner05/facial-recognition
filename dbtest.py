...
def select_users(conn):
    ...
    known_company_ids = response_data['company_ids']
    known_employee_ids = response_data['employee_ids']
    list_of_face_encodings = response_data['face_encodings']
    
    known_face_encodings = []
    
    for face in list_of_face_encodings:
        # print("face:", face)
    #     facedata = base64.b64decode(bytes(str(face)), 'utf-8')
    #     print(facedata)
        print(type(face))
        # facedata = base64.b64decode(face, 'utf-8')
        facedata = np.array(face)
        print(type(facedata))
        ...
        known_face_encodings.append(facedata)
    ...
    while True:
        ...
        if process_this_frame:
            ...
            face_names = []
            while face_encodings:
                cv2.imwrite(os.path.join('compare.jpg'))
                break
